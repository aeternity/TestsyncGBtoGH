...
Please refer to the [standard library](https://docs.aeternity.com/aesophia/v8.0.1/sophia\_stdlib/#map) for the predefined functionalities.
...
#### Before ceres <a href="#before-ceres" id="before-ceres"></a>
